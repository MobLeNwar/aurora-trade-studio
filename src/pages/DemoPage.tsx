// This is the legacy demo page. Homepage replaced by HomePage.tsx. Keeping for reference.
/**
    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-background text-foreground p-4 overflow-hidden">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto text-pretty">
          This page is no longer in use. The application homepage is now HomePage.tsx.
        </p>
      </motion.div>
